...
TermlibInvaders = {
	...
	invStep: function(inv) {
		...
		var shot = (inv.shot > 0),
			shotx = inv.shotX,
			shoty = inv.shipY - inv.shot;
		var bomb = inv.bomb,
			block = inv.block,
			blocky = inv.blockY,
			isblockrow = false;
		var sprites = TermlibInvaders.sprites,
			invclr = inv.invaderColor;
...
var clientip = "%c(@lightgrey)202.189.0.30";
var vartop = ["%c(@lightgrey)last pid: 21715;  load averages:  0.43,  0.38,  0.30  up 250+20:04:13    09:29:03",
	"%c(@lightgrey)77 processes:  1 running, 76 sleeping",
	"%c(@lightgrey)",
	"%c(@lightgrey)Mem: 295M Active, 635M Inact, 2848M Wired, 55M Free",
	"%c(@lightgrey)ARC: 1849M Total, 1385M MFU, 199M MRU, 999K Anon, 27M Header, 237M Other",
	"%c(@lightgrey)Swap: 512M Total, 102M Used, 410M Free, 19% Inuse",
	"%c(@lightgrey)",
	"%c(@lightgrey)",
	"%c(@lightgrey)  PID USERNAME     THR PRI NICE   SIZE    RES STATE   C   TIME    WCPU COMMAND",
	"%c(@lightgrey)82575 www            1  20    0   143M 11216K piperd  3   0:07   0.29% httpd",
	"%c(@lightgrey)27144 www            1  20    0   143M 11788K lockf   3   0:07   0.20% httpd",
	"%c(@lightgrey)  798 root           1  20    0 10472K   768K select  3  79:52   0.00% syslogd",
	"%c(@lightgrey)  841 root           2  20    0 71860K 11948K select  0  38:14   0.00% spamass-",
	"%c(@lightgrey)38440 root           1  20    0 45944K  1736K accept  2  35:23   0.00% saslauth",
	"%c(@lightgrey)38442 root           1  20    0 45944K  1728K lockf   0  35:20   0.00% saslauth",
	"%c(@lightgrey)38439 root           1  20    0 45944K  1728K lockf   0  35:18   0.00% saslauth",
	"%c(@lightgrey)38441 root           1  20    0 45944K  1724K lockf   0  35:18   0.00% saslauth",
	"%c(@lightgrey)38438 root           1  20    0 45944K  1744K lockf   0  35:17   0.00% saslauth",
	"%c(@lightgrey)  870 mailnull       4  20    0 81788K 18192K select  1  27:45   0.00% opendkim",
	"%c(@lightgrey)46375 root           1  20    0 47864K  4184K select  0  25:49   0.00% sendmail",
	"%c(@lightgrey)  864 root           3  20    0 58604K 12424K select  2  23:23   0.00% sid-filt",
	"%c(@lightgrey)  904 dcc            3  20    0 24980K  1964K select  3  15:11   0.00% dccifd",
	"%c(@lightgrey) 6353 spamd          1  52    0   323M   231M select  3  12:49   0.00% perl",
	"%c(@lightgrey)97843 root           1  20    0   141M  7176K select  2   8:43   0.00% httpd",
	"%c(@lightgrey)  874 root           1  20    0 14680K   760K select  1   5:21   0.00% inetd",
	"%c(@lightgrey)11690 root           1  20    0   299M   206M select  3   3:59   0.00% perl",
	"%c(@lightgrey)15590 spamd          1  20    0   309M   216M select  3   1:52   0.00% perl",
	"%c(@lightgrey)  946 root           1  20    0 12564K   488K nanslp  2   1:26   0.00% cron",
	"%c(@lightgrey)  881 nobody         2  20    0 28920K  1684K accept  3   1:13   0.00% in.imapp",
	"%c(@lightgrey)29165 www            1  20    0   148M 17748K lockf   2   0:50   0.00% httpd",
	"%c(@lightgrey)40048 www            1  20    0   148M 13184K lockf   2   0:45   0.00% httpd",
	"%c(@lightgrey)29193 www            1  21    0   146M 11800K lockf   2   0:43   0.00% httpd",
	"%c(@lightgrey)40135 www            1  20    0   146M 11896K lockf   2   0:42   0.00% httpd",
	"%c(@lightgrey)40132 www            1  20    0   148M 13840K lockf   2   0:41   0.00% httpd",
	"%c(@lightgrey)55526 www            1  20    0   146M 11784K lockf   2   0:41   0.00% httpd",
	"%c(@lightgrey)",
];
var vardf = ["%c(@lightgrey)Filesystem 1K-blocks     Used     Avail Capacity  Mounted on",
	"%c(@lightgrey)zroot/data 204800000 43094420 161705580    21%    /",
